...
Draft a [new release](https://github.com/jtdub/nautobot-app-remote-jobs/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/jtdub/nautobot-app-remote-jobs/pull/123` -> `* @nautobot_user`.
...
**Full Changelog**: https://github.com/jtdub/nautobot-app-remote-jobs/compare/v1.4.1...v1.4.2
```
