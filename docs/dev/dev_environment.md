...
- `project_name`: the default docker compose project name (default: `remote-jobs`)
...
Using **Invoke** these configuration options can be overridden using [several methods](https://docs.pyinvoke.org/en/stable/concepts/configuration.html). Perhaps the simplest is setting an environment variable `INVOKE_NAUTOBOT_REMOTE_JOBS_VARIABLE_NAME` where `VARIABLE_NAME` is the variable you are trying to override. The only exception is `compose_files`, because it is a list it must be overridden in a YAML file. There is an example `invoke.yml` (`invoke.example.yml`) in this directory which can be used as a starting point.
...
#14 naming to docker.io/remote-jobs/nautobot:3.0.0-py3.12 done
```
...
Creating network "nautobot_remote_jobs_default" with the default driver
Creating volume "nautobot_remote_jobs_postgres_data" with default driver
Creating nautobot_remote_jobs_redis_1 ...
Creating nautobot_remote_jobs_docs_1  ...
Creating nautobot_remote_jobs_postgres_1 ...
Creating nautobot_remote_jobs_postgres_1 ... done
Creating nautobot_remote_jobs_redis_1    ... done
Creating nautobot_remote_jobs_nautobot_1 ...
Creating nautobot_remote_jobs_docs_1     ... done
Creating nautobot_remote_jobs_nautobot_1 ... done
Creating nautobot_remote_jobs_worker_1   ...
Creating nautobot_remote_jobs_worker_1   ... done
...
ee90fbfabd77   remote-jobs/nautobot:3.0.0-py3.12  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_remote_jobs_worker_1
b8adb781d013   remote-jobs/nautobot:3.0.0-py3.12  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_remote_jobs_nautobot_1
d64ebd60675d   remote-jobs/nautobot:3.0.0-py3.12  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_remote_jobs_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   nautobot_remote_jobs_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   nautobot_remote_jobs_redis_1
```
...
Stopping nautobot_remote_jobs_worker_1   ...
Stopping nautobot_remote_jobs_nautobot_1 ...
Stopping nautobot_remote_jobs_docs_1     ...
Stopping nautobot_remote_jobs_redis_1    ...
Stopping nautobot_remote_jobs_postgres_1 ...
Stopping nautobot_remote_jobs_worker_1   ... done
Stopping nautobot_remote_jobs_nautobot_1 ... done
Stopping nautobot_remote_jobs_postgres_1 ... done
Stopping nautobot_remote_jobs_redis_1    ... done
Stopping nautobot_remote_jobs_docs_1     ... done
Removing nautobot_remote_jobs_worker_1   ...
Removing nautobot_remote_jobs_nautobot_1 ...
Removing nautobot_remote_jobs_docs_1     ...
Removing nautobot_remote_jobs_redis_1    ...
Removing nautobot_remote_jobs_postgres_1 ...
Removing nautobot_remote_jobs_postgres_1 ... done
Removing nautobot_remote_jobs_docs_1     ... done
Removing nautobot_remote_jobs_worker_1   ... done
Removing nautobot_remote_jobs_redis_1    ... done
Removing nautobot_remote_jobs_nautobot_1 ... done
Removing network nautobot_remote_jobs_default
```
...
So for example, our app is named `remote-jobs`, the command would most likely be `docker logs nautobot_remote_jobs_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("nautobot_remote_jobs")
namespace.configure(
    {
        "nautobot_remote_jobs": {
            ...
...
Or set the `INVOKE_NAUTOBOT_REMOTE_JOBS_PYTHON_VER` variable.
...
Or set the `INVOKE_NAUTOBOT_REMOTE_JOBS_NAUTOBOT_VER` variable.
...
In the package source, there is the `nautobot_remote_jobs/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
